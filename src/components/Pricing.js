    ...
    >
      <div className="container mx-auto mb-16 px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="text-lg space-y-2">
            <p>
              - Biaya pribadi ini tidak diserahkan ke Areta Informatics College,
              melainkan digunakan langsung oleh peserta.
            </p>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Kartu 1 */}
          <article className="p-8 rounded-lg border border-gray-300 dark:border-gray-700 dark:bg-gray-700 shadow">
          ...
          {/* Kartu 3 */}
          <article className="p-8 rounded-lg border border-gray-300 dark:border-gray-700 dark:bg-gray-700 shadow flex flex-col justify-between">
            <div className="mt-6 space-y-4">
              <CostItem
            ...
            <a
              href="#"
              className="block text-center bg-blue-100 dark:bg-gray-600 text-black dark:text-gray-200 py-3 px-4 rounded-lg font-semibold mt-6"
              role="button"
...
function CostItem({ icon, text }) {
  return (
    <div className="flex items-start mb-4 text-blue-600 dark:text-blue-300">
